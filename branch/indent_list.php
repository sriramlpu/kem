          ...
          <div class="row mb-3">
            <div class="col-md-6">
              <div class="d-flex align-items-center">
                ...
                <span class="badge bg-light text-success me-2">OPEN: <span id="count_open">0</span></span>
                <span class="badge bg-light text-secondary me-2">CLOSED: <span id="count_closed">0</span></span>
    ...
    <div class="modal-content shadow-lg">
      ...
      <div class="modal-body">
        <form id="editIndentForm">
          ...
          <input type="hidden" id="edit_raised_by" name="raised_by" value="<?=$userId?>">
           <input type="hidden" id="edit_branch" name="branch" value="<?=$branchId?>">
    ...
    function loadUsers(selectId) {
      $.getJSON('./api/users_api.php?action=list', function(res) {
        ...
        res.data.forEach(function(user) {
          sel.append(`<option value="${user.id}">${user.username}</option>`);
        });
      });
    }
        ...
        ajax: {
          ...
          dataSrc: function(json) {
            ...
            if (json.status_counts) {
              $('#count_open').text(json.status_counts.open || 0);
            ...
            render: function(status) {
              ...
              switch(status) {
                ...
                case 'CANCELLED':
                  ...
                  break;
                default:
                  badge = '<span class="badge bg-light text-dark">' + status + '</span>';
              }
              return badge;
            }
          },
          {
            ...
            render: function(id, type, row) {
              return `
                ...
                <button class="btn btn-sm btn-outline-danger cancel-indent" data-id="${id}" title="Cancel">
                  <i class="bi bi-ban"></i>
                </button>
              `;
            }
