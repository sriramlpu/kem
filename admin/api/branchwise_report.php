  ...
  <div class="row g-4">
    <div class="col-12">
      <div class="card shadow-sm border-0">
        ...
        <div class="card-body">
          <!-- Filters: ONLY Category, Status, Search -->
...
<!-- DataTables + Buttons (uncomment if not already included globally) -->
<!--
  ...
  var table = $('#subCategoryTable').DataTable({
    ...
    columns: [
      ...
      { data: 'status' },
      {
        ...
        render: function(id){
          return '<a class="btn btn-sm btn-outline-secondary" href="view_subcategory.php?id='+id+'" title="View">View</a>';
        }
      }
    ],
    order: [[0, 'desc']]
