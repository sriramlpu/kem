...
if ($action === 'create') {
    ...
    $stmt = excuteSql("INSERT INTO vendors (vendor_name,email,phone,gstin,address,city,state,country,pincode) VALUES ('$vendor_name','$email','$phone','$gstin','$address','$city','$state','$country','$pincode')");
...
if ($action === 'edit') {
    ...
    $sql = excuteSql("UPDATE vendors SET vendor_name='$vendor_name',email='$email',phone='$phone',gstin='$gstin',address='$address',city='$city',state='$state',country='$country',pincode='$pincode',status='$status' WHERE vendor_id='$id'");
