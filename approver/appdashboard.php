 ...
 * Path: appdashboard.php
 * UPDATED: Synchronized tab labels and category logic with Requester Dashboard.
 * UPDATED: Added 'Advances' to the main navigation and KPI tracking.
 */
session_start();
...
if (!array_key_exists($activeTab, $tabs_config)) $activeTab = 'dashboard';
                    ...
                    <tbody>
                        <?php foreach ($rows as $r):
                            ...
                            if ($type === 'employee') {
                                ...
                                if ($gross > 21000 && $esi > 0) {
                                    $hasError = true;
                                    $errorMsg = "ESI Compliance Error: Gross > 21k.";
                                }
                        ...
                        ?>
                            <tr class="<?= $hasError ? 'table-danger-subtle' : '' ?>">
                                ...
                                <td>
                                    <div class="small fw-medium"><?= h($requestor) ?></div>
                                </td>
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-3">
        <h2 class="mb-0 text-dark fw-bold h4">Authorization Desk</h2>
    </div>

    <!-- Category Tabs -->
    <ul class="nav nav-tabs mb-4 border-0">
        <?php foreach ($tabs_config as $t => $label): ?>
            <li class="nav-item">
    ...
    <div class="tab-content">
        ...
        render_approver_table($tableData, ucfirst($activeSub) . " " . h($tabs_config[$activeTab]) . " List", $showBulk);
        ?>
    </div>
</div>
