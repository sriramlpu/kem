...
$email = $getUser["email"] ?? "";
$phone = $getUser["phone"]?? "";
$role = getField('roles', $getUser["role_id"], 'role_name', 'role_id' )?? "";
...
<style>
  ...
  padding: 0;
  margin: 0;
  pointer-events: none; /* allow clicks through when no alert is visible */
}

#alert-container .alert {
  display: inline-block;
  pointer-events: auto; /* enable pointer events only when alert exists */
  font-size: 1.25rem;
  padding: 20px 24px;
  border-radius: 12px;
