<?php
/**
 * Global Navigation: Updated to support Admin, Requester, and Cashier roles.
 */
// Session is usually started in header.php, but we ensure it's available
if (session_status() === PHP_SESSION_NONE) {
    session_start();
}

$userName = $_SESSION['userName'] ?? 'User';
// Role should be set in header.php, but we provide a fallback
